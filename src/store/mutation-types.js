...
export const RECEIVE_SHOPS = 'receive_shops'//接受食品分类数组
export const RECEIVE_USER_INFO = 'receive_user_info'//接受用户信息
export const RESET_USER_INFO = 'reser_info'//重置用户信息
...
export const RECEIVR_SEARCH_SHOPS='receive_search_shops'//接受搜索的商家信息
